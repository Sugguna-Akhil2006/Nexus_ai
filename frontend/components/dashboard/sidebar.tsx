...
const NAV_ITEMS: NavigationItem[] = [
  ...
  { label: "GitHub Analyzer", href: "/dashboard/github-analyzer", icon: GithubIcon, shortcut: "⌘8" },
  { label: "Analytics", href: "/dashboard/analytics", icon: BarChart3, shortcut: "⌘9" },
  { label: "Admin", href: "/dashboard/admin", icon: ShieldCheck, shortcut: "⌘0", adminOnly: true },
