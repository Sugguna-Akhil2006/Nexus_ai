...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-[15px] leading-tight font-medium group-data-[size=sm]/card:text-sm text-foreground tracking-[-0.01em]",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-(--card-spacing) text-[13px] text-muted-foreground leading-relaxed", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl border-t border-border bg-muted/20 p-(--card-spacing)",
        className
      )}
      {...props}
    />
